var video = {
  "count": 698159,
  "next": "https://api.rawg.io/api/games?key=ce951e4a85544044bff31a97fc7d863d&page=2",
  "previous": null,
  "results": [
    {
      "id": 3498,
...
var videomap = video.results.map(e => e.platforms.map(e=> e.platform.name));
var videomap2 = videomap.map (e => {
for ( i in e) return e[i]});


console.log(videomap2)